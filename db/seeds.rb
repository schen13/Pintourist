...
pin1.photo.attach(io: File.open('./app/assets/images/cherry_blossom.jpg'), filename: 'cherry_blossom.jpg')
pin1.save!
...
pin2.photo.attach(io: File.open('./app/assets/images/santorini.jpg'), filename: 'santorini.jpg')
pin2.save!
...
pin3.photo.attach(io: File.open('./app/assets/images/Neuschwanstein.jpg'), filename: 'Neuschwanstein.jpg')
pin3.save!
...
pin4.photo.attach(io: File.open('./app/assets/images/louvre.jpg'), filename: 'louvre.jpg')
pin4.save!
...
pin5.photo.attach(io: File.open('./app/assets/images/aurora.jpg'), filename: 'aurora.jpg')
pin5.save!
...
pin6.photo.attach(io: File.open('./app/assets/images/bamboo_forest.jpg'), filename: 'bamboo_forest.jpg')
pin6.save!
...
pin7.photo.attach(io: File.open('./app/assets/images/panda.jpg'), filename: 'panda.jpg')
pin7.save!
...
pin8.photo.attach(io: File.open('./app/assets/images/jiuzhaigou.jpg'), filename: 'jiuzhaigou.jpg')
pin8.save!
...
pin9.photo.attach(io: File.open('./app/assets/images/potala_palace.jpg'), filename: 'potala_palace.jpg')
pin9.save!
...
pin10.photo.attach(io: File.open('./app/assets/images/jerusalem.jpg'), filename: 'jerusalem.jpg')
pin10.save!
...
pin11.photo.attach(io: File.open('./app/assets/images/ice_caps.jpg'), filename: 'ice_caps.jpg')
pin11.save!
...
pin12.photo.attach(io: File.open('./app/assets/images/serengeti.jpg'), filename: 'serengeti.jpg')
pin12.save!
...
pin13.photo.attach(io: File.open('./app/assets/images/montreal_garden.jpg'), filename: 'montreal_garden.jpg')
pin13.save!
...
pin14.photo.attach(io: File.open('./app/assets/images/huacachina.jpg'), filename: 'huacachina.jpg')
pin14.save!
...
pin15.photo.attach(io: File.open('./app/assets/images/marble_caves.jpg'), filename: 'marble_caves.jpg')
pin15.save!
...
pin16.photo.attach(io: File.open('./app/assets/images/great_wall.jpg'), filename: 'great_wall.jpg')
pin16.save!
...
pin17.photo.attach(io: File.open('./app/assets/images/petra.jpg'), filename: 'petra.jpg')
pin17.save!
...
pin18.photo.attach(io: File.open('./app/assets/images/christ.jpg'), filename: 'christ.jpg')
pin18.save!
...
pin19.photo.attach(io: File.open('./app/assets/images/machu_picchu.jpg'), filename: 'machu_picchu.jpg')
pin19.save!
...
pin20.photo.attach(io: File.open('./app/assets/images/chichen_itza.jpg'), filename: 'chichen_itza.jpg')
pin20.save!
...
pin21.photo.attach(io: File.open('./app/assets/images/colosseum.jpg'), filename: 'colosseum.jpg')
pin21.save!
...
pin22.photo.attach(io: File.open('./app/assets/images/taj_mahal.jpg'), filename: 'taj_mahal.jpg')
pin22.save!
...
pin23.photo.attach(io: File.open('./app/assets/images/grand_canyon.jpg'), filename: 'grand_canyon.jpg')
pin23.save!
...
pin24.photo.attach(io: File.open('./app/assets/images/great_barrier_reef.jpg'), filename: 'great_barrier_reef.jpg')
pin24.save!
...
pin25.photo.attach(io: File.open('./app/assets/images/guanabara_bay.jpg'), filename: 'guanabara_bay.jpg')
pin25.save!
...
pin26.photo.attach(io: File.open('./app/assets/images/everest.jpg'), filename: 'everest.jpg')
pin26.save!
...
pin27.photo.attach(io: File.open('./app/assets/images/paricutin.jpg'), filename: 'paricutin.jpg')
pin27.save!
...
pin28.photo.attach(io: File.open('./app/assets/images/victoria_falls.jpg'), filename: 'victoria_falls.jpg')
pin28.save!
...
pin29.photo.attach(io: File.open('./app/assets/images/old_faithful.jpg'), filename: 'old_faithful.jpg')
pin29.save!
...
pin30.photo.attach(io: File.open('./app/assets/images/mt_fuji.jpg'), filename: 'mt_fuji.jpg')
pin30.save!
...
pin31.photo.attach(io: File.open('./app/assets/images/vegas.jpg'), filename: 'vegas.jpg')
pin31.save!
...
pin32.photo.attach(io: File.open('./app/assets/images/burj_khalifa.jpg'), filename: 'burj_khalifa.jpg')
pin32.save!
...
pin33.photo.attach(io: File.open('./app/assets/images/statue_of_liberty.jpg'), filename: 'statue_of_liberty.jpg')
pin33.save!
...
pin34.photo.attach(io: File.open('./app/assets/images/times_square.jpg'), filename: 'times_square.jpg')
pin34.save!
...
pin35.photo.attach(io: File.open('./app/assets/images/leaning_tower.jpg'), filename: 'leaning_tower.jpg')
pin35.save!
...
pin36.photo.attach(io: File.open('./app/assets/images/disneyland.jpg'), filename: 'disneyland.jpg')
pin36.save!
...
pin37.photo.attach(io: File.open('./app/assets/images/opera_house.jpg'), filename: 'opera_house.jpg')
pin37.save!
